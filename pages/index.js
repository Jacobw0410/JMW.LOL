      ...
      <div className="home-container">
          ...
          <header data-thq="thq-navbar" className="home-navbar-interactive">
            ...
            <div data-thq="thq-navbar-nav" className="home-desktop-menu">
              <nav className="home-links">
                <span>About</span>
                <span className="home-nav2">Projects</span>
              ...
              <div className="home-container4">
                ...
                >
                  <FeatureCard
                    ...
                    SubHeading="Enhance your website with high-quality, modern photographs that showcase your tech expertise."
        ...
        <div className="home-banner">
          <div className="home-banner1">
            ...
            <Link href="/home1">
              <a className="home-link2 button">View Projects</a>
            </Link>
          </div>
        </div>
          ...
          <div className="home-faq-container">
            <div className="home-faq1">
              ...
              <div className="home-container6">
                <Question
                  Answer="I specialize in Python, Java, and C++."
                  Question="What programming languages do you specialize in?"
                ></Question>
                <Question
                  Answer="I have worked on projects related to software development, robotics, and automation."
                  Question="What engineering projects have you worked on?"
                ></Question>
                <Question
                  Answer="Yes, you can find examples of my past projects in the 'My Projects' section of this website."
                  Question="Can you provide examples of your past projects?"
                ></Question>
                <Question
                  Answer="Yes, you can find links to my social media accounts linked at the bottom of this Website."
                  Question="Do you have any social media accounts?"
                ></Question>
                <Question
                  Answer="I am a programmer and engineer with a passion for creating sleek and minimalist websites. I love incorporating modern techy photos into my designs. My expertise lies in developing innovative solutions using cutting-edge technologies. Feel free to explore my website to learn more about me and my work."
